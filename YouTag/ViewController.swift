...
class ViewController: UIViewController, FilterPickerViewDelegate, YYTTagViewDelegate {
	...
	override func viewDidLoad() {
		...
		tagsView = YYTFilterTagView(frame: .zero, tagsList: NSMutableArray(), isAddEnabled: false, isMultiSelection: false, isDeleteEnabled: true, areSuggestionsEnabled: false, isForArtists: false)
