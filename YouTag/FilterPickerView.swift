...
class FilterPickerView: UIView {
	...
	init() {
		...
		tagView = YYTTagView(frame: .zero, tagsList: LibraryManager.getAll(.tags), isAddEnabled: false, isMultiSelection: true, isDeleteEnabled: false, areSuggestionsEnabled: true, isForArtists: false)
